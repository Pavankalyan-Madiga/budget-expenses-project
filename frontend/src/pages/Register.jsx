...
function Spinner({ className = 'h-4 w-4' }) {
    return (<svg className={`animate-spin ${className}`} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export default function Register() {
    ...
    return (<div className="min-h-screen flex bg-[#0a0a0f] text-white font-sans">
      ...
      <div className="w-full lg:w-1/2 bg-[#12121a] flex items-center justify-center p-8 lg:p-12">
        <div className="w-full max-w-md space-y-8">
          ...
          {errorMsg && (<div className="bg-red-500/10 border border-red-500/30 text-red-400 text-sm rounded-lg px-4 py-3">
              {errorMsg}
            </div>)}
          {successMsg && (<div className="bg-green-500/10 border border-green-500/30 text-green-400 text-sm rounded-lg px-4 py-3 flex items-center gap-2">
          ...
          <form onSubmit={handleRegister} className="space-y-5">
            ...
            {slowNotice && (<p className="text-xs text-gray-500 text-center">
